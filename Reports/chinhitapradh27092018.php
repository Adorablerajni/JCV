  ...
  ?>
	...
	<td>गत वर्ष</td>
	  ...
	  <!--<td>हत्या, हत्या का प्रयास, बलात्कार एवं डकैती</td>-->
            ...
            $d='12';
            $dsr_chinhit ='हाँ';
            if ( !$stmt2 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_chinhit = ? and sp_id = ? AND dsr_chinhit_date BETWEEN ? AND ? ") ) //dsr_kaymi_date AND (dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ?)
            echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
            if ( !$stmt2->bind_param("siss",$dsr_chinhit, $branch_id1, $datef, $date1) ) //, $h, $hp, $b, $d
            ...
            $d='12';
            $dsr_chinhit ='हाँ';
            if ( !$stmt17 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_chinhit = ? and sp_id = ? AND dsr_chinhit_date BETWEEN ? AND ? ") ) //AND (dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ?)
            echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
            if ( !$stmt17->bind_param("siss",$dsr_chinhit,$branch_id1,$newDate1,$newDate2) )//,$h,$hp,$b,$d
            echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
            if ( !$stmt17->execute() ) 
            ...
            $d='12';
            $dsr_chinhit ='हाँ';
            if ( !$stmt18 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_chinhit = ? and sp_id = ? AND dsr_chinhit_date BETWEEN ? AND ? ") ) // AND dsr_chinhit = ? AND (dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ? OR dsr_vidhan_ipc = ?)
            echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
            if ( !$stmt18->bind_param("siss",$dsr_chinhit,$branch_id1,$newDate3,$newDate4) ) //,$dsr_chinhit ,$h,$hp,$b,$d
            echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
            if ( !$stmt18->execute() ) 

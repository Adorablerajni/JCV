...
<div class="card position-relative">
                ...
                <div class="form-group row">
                  <div class="col-lg-4">
                    <input type="text" class="form-control form-control-user" id="txtShiftName" name="txtShiftName" placeholder="Shift Name" autocomplete="off"/>
                  </div>
                  <div class="col-lg-4">
                     ...
                     <table class="table table-striped table-bordered" id="example">
                        <thead>
                           <tr>
                              ...
                              <th style="text-align:center;">Shift Start Time</th>
                              <th style="text-align:center;">Shift End Time</th>
                           </tr>
                        </thead>
                        <tbody>
						<?php $count = 1 ;

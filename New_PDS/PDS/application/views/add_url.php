            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="add_url_form" method="POST" action="<?php echo base_url(); ?>add_url">
                                <div class="row clearfix">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button class="btn btn-warning waves-effect add_url_submit" name="add_url_submit" type="submit">ADD</button>
                                    </div>
                                </div>

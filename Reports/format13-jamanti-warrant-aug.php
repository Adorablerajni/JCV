...
<title>Format13-jamanti-warrant | File Tracking & Crime Analysis Application </title>
<!-- GLOBAL STYLES -->
...
<span style="float:right;margin-right:-25px"> <input type="hidden" id="datatodisplay" name="datatodisplay" style="" /> <input type="submit" value="Export to Excel"/>
  ...
  <div class="row">
    <div class="col-lg-12">
      <form action="format13-jamanti-warrant.php" method="post" name="Search" enctype="multipart/form-data" id="popup-validation" role="form">
  ...
  <?php
   ...
   {
  ?>
<p align="left" style="float:left;margin-left:-30px;">Format13-jamanti-warrant</p>
<p align="right"></p>
  <div class="mar10">
  <?php   
  ...
  ?>
    <p align="center"><span>जमानती वारंट पुलिस अधिकारी/कर्मचारीः- दि. <?php if ($_POST['datef'] == ''){	echo '';} else{echo date('d-m-Y', strtotime($_POST['datef']));

...
<head>
    ...
    <title>Upload Products | Mercure DPA</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?php echo base_url(); ?>Masters/products_csv_import" method="post" name="upload_excel" id="validation-form" enctype="multipart/form-data">

                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <textarea id="reply<?php echo $i; ?>" name="reply<?php echo $i; ?>" rows="6" class="form-control"></textarea>
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="submit_ajax<?php echo $i; ?>" class="btn bg-orange waves-effect">SAVE ANSWER</button>

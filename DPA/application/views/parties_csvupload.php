...
<head>
    ...
    <title>Upload Parties | Mercure DPA</title>
    <!-- Favicon-->
           ...
           <!-- Basic Validation -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Upload Parties</h2>
                            
                        </div>
                        <div class="body">
                            <form action="<?php echo base_url(); ?>Masters/parties_csv_import" method="post" name="upload_excel" id="validation-form" enctype="multipart/form-data">

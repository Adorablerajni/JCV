	...
	<div class="card position-relative">
         ...
         <div class="row">
			<form action="<?php echo site_url(); ?>Allotment/show_stock_list" class="col-sm-12" method="POST" >
				...
				<div class="col-lg-3">
					<input type="submit" name="submit1"class="btn btn-primary btn-user btn-block"  value="View Stock's"/>
				</div>
				</div>
            </form>
		  </div>
          ...
          <div class="row"> 
				...
				<div class="col-sm-12">
                     ...
                     <table class="table table-striped table-bordered" id="example">
                        ...
                        ?> 
                        <tr>
						    <input type="hidden" class="form-control form-control-user" id="txtOrderId"  name="txtOrderId[]" value="<?php echo $val['order_id'];?>" />
							<input type="hidden" class="form-control form-control-user" id="txtCheckinId"  name="txtCheckinId[]" value="<?php echo $val['id'];?>" />
							<input type="hidden" class="form-control form-control-user" id="txtSupplierId"  name="txtSupplierId[]" value="<?php echo $val['supplier_name'];?>" />
                     ...
                     <table class="table table-striped table-bordered" id="example">
                        <thead>
                           <tr>
                              ...
                              <th style="text-align:center;">Stock Rate</th>
                              <th style="text-align:center;">Stock Amount</th>

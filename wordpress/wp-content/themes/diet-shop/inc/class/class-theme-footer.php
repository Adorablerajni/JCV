...
class Diet_Shop_Site_Footer{
	...
	*/
	public function site_copywrite_text (){
		...
		$html  .= sprintf( esc_html__( ' %1$s  By aThemeArt - Proudly powered by %2$s .', 'diet-shop' ), '<a href="'. esc_url( 'https://athemeart.com/downloads/dietshop-wordpress-gym-theme/' ) .'" target="_blank" rel="nofollow">'.esc_html_x( 'Diet Shop Theme ', 'credit text - theme', 'diet-shop' ).'</a>', '<a href="'.esc_url( __( 'https://wordpress.org', 'diet-shop' ) ).'" rel="nofollow" target="_blank" rel="nofollow">'.esc_html_x( 'WordPress', 'credit text - cms', 'diet-shop' ).'</a>' );

...
<table border="1" cellspacing="0" cellpadding="5" style="font-size:12px;line-height:20px;margin-left:-30px;text-align:center" id="print" width="960px">
  ...
  <tr>
	...
	$stmt2 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$stmt3 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	...
	$stmt4 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc2[$i]=$cid3;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$vivechna = 'विवेचना में लंबित';
	$stmt5 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc3[$i]=$cid4;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$bandi = 'बंदी आरोपी';
	$stmt6 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc4[$i]=$cid5;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$bandi = 'बंदी आरोपी';
	$stmt7 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc5[$i]=$cid6;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$khatma = 'खात्मा';
	$stmt8 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc6[$i]=$cid7;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$khatma = 'खात्मा';
	$stmt9 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc7[$i]=$cid8;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$kharji = 'खारची';
	$stmt10 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	$stmt10->bind_param("iisssss", $j, $branch_id, $sc, $datef, $date1,$kharji, $atyachar);
    $stmt10->execute();
    $stmt10->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc8[$i]=$cid9;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$kharji = 'खारची';
	$stmt11 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	$stmt11->bind_param("iisssss", $j, $branch_id, $st, $datef, $date1,$kharji, $atyachar);
    $stmt11->execute();
    $stmt11->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc9[$i]=$cid10;	
	...
	$stmt12 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc10[$i]=$cid11;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$nyay = 'न्यायालय में प्रस्तुत';
	$stmt13 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc11[$i]=$cid12;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$dandit = 'सजा';
	$stmt14 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc12[$i]=$cid13;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$dandit = 'सजा';
	$stmt15 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc13[$i]=$cid14;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$doshmukt = 'दोषमुक्त';
	$stmt16 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc14[$i]=$cid15;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$doshmukt = 'दोषमुक्त';
	$stmt17 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
...
$ipc15[$i]=$cid16;	
	...
	$stmt18 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	$stmt18->bind_param("iisssss", $j, $branch_id, $sc, $datef, $date1,$nyay_lambit, $atyachar);
    $stmt18->execute();
    $stmt18->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc16[$i]=$cid17;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$nyay_lambit = 'न्यायालय में लंबित';
	$stmt19 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	$stmt19->bind_param("iisssss", $j, $branch_id, $st, $datef, $date1,$nyay_lambit, $atyachar);
    $stmt19->execute();
    $stmt19->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc17[$i]=$cid18;	
	...
	$stmt20 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	$stmt20->bind_param("iisssss", $j, $branch_id, $sc, $datef, $date1,$vivechna_dhin, $atyachar);
    $stmt20->execute();
    $stmt20->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc18[$i]=$cid19;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$vivechna_dhin = 'विवेचनाधीन';
	$stmt21 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND sp_id = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND (atyachar_adhiniyam = ? or atyachar_adhiniyam is null)");
	$stmt21->bind_param("iisssss", $j, $branch_id, $st, $datef, $date1,$vivechna_dhin, $atyachar);
    $stmt21->execute();
    $stmt21->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }

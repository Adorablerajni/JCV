          ...
          <div class="row">
                ...
                <div class="form-group row">
					<div class="col-lg-4">
						...
						<option>Plant Instrument</option>
						...
						<option>Staff Requirement Items</option>
						</select>
					</div>
					<div class="col-lg-4">
						<input type="text" class="form-control form-control-user" id="txtStockName" name="txtStockName" placeholder="Stock Name"/>
					</div>
					<div class="col-lg-3">

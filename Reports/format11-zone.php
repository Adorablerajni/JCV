...
<title>P-11 -Zone | File Tracking & Crime Analysis Application </title>
<!-- GLOBAL STYLES -->
...
<span style="float:right;margin-right:-25px"> <input type="hidden" id="datatodisplay" name="datatodisplay" style="" /> <input type="submit" value="Export to Excel" class="btn btn-warning"/>
 ...
 <div class="row">
    <div class="col-lg-12 label-primary" style="color:#FFF">
      <form action="format11-zone.php" method="post" name="Search" enctype="multipart/form-data" id="popup-validation" role="form">
...
<table border="1" cellspacing="0" cellpadding="5" style="text-align:center" id="print" width="960px" class="table table-striped table-bordered table-hover">
  ...
  <tr>
	...
	$stmt2 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND atyachar_adhiniyam = ?");
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$stmt3 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND atyachar_adhiniyam = ?");
...
$ipc1[$i]=$cid2;	
	...
	$stmt4 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc2[$i]=$cid3;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$vivechna ='विवेचना में लंबित';
	$stmt5 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc3[$i]=$cid4;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$bandi ='बंदी आरोपी';
	$stmt6 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$bandi ='बंदी आरोपी';
	$stmt7 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc5[$i]=$cid6;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$khatma ='खात्मा';
	$stmt8 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc6[$i]=$cid7;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$khatma ='खात्मा';
	$stmt9 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc7[$i]=$cid8;	
	...
	$kharji ='खारची';
	$kharji1 ='ख़ारजी';
	$stmt10 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND (c_status = ? OR c_status = ?) AND atyachar_adhiniyam = ?");
	$stmt10->bind_param("issssss", $j, $sc, $datef, $date1, $kharji, $kharji1, $atyachar);
    $stmt10->execute();
    $stmt10->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc8[$i]=$cid9;	
	...
	$kharji ='खारची';
	$kharji1 ='ख़ारजी';
	$stmt11 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND (c_status = ? OR c_status = ?) AND atyachar_adhiniyam = ?");
	$stmt11->bind_param("issssss", $j, $st, $datef, $date1, $kharji, $kharji1, $atyachar);
    $stmt11->execute();
    $stmt11->store_result();
    //if($stmt3->num_rows === 0) { echo "No Results"; }
...
$ipc9[$i]=$cid10;	
	...
	$stmt12 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc10[$i]=$cid11;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$nyay = 'न्यायालय में प्रस्तुत';
	$stmt13 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_status = ? AND atyachar_adhiniyam = ?");
...
$ipc11[$i]=$cid12;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$dandit = 'सजा';
	$stmt14 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND atyachar_adhiniyam = ?");
...
$ipc12[$i]=$cid13;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$dandit = 'सजा';
	$stmt15 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND atyachar_adhiniyam = ?");
...
$ipc13[$i]=$cid14;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$doshmukt = 'दोषमुक्त';
	$stmt16 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND atyachar_adhiniyam = ?");
...
$ipc14[$i]=$cid15;	
	...
	<?php
 	$police_dsr->select_db("ftcaaazc_dsr");
	$doshmukt = 'दोषमुक्त';
	$stmt17 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE dsr_vidhan_ipc = ? AND dsr_caste = ? AND (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND c_decision = ? AND atyachar_adhiniyam = ?");

...
<title>Format-19-A | File Tracking & Crime Analysis Application </title>
<!-- GLOBAL STYLES -->
...
<span style="float:right;margin-right:-25px"> <input type="hidden" id="datatodisplay" name="datatodisplay" style="" /> <input type="submit" value="Export to Excel" class="btn btn-warning"/>
 ...
 <div class="row">
    <div class="col-lg-12 label-primary" style="color:#FFF">
      <form action="format19-A.php" method="post" name="Search" enctype="multipart/form-data" id="popup-validation" role="form">
...
<div class="notice_all">
  ...
  {
  ?>
  <p align="left" style="float:left;margin-left:-30px;">Format-19-A</p>
  <p align="right"></p>
  <div class="mar10">
  <?php
  $police_tracking->select_db("ftcaaazc_epfts");
  ...
  { 
  ?>
    <p align="center"><span>महिलाओं पर घटित अपराधों की मासिक जानकारी। <br /> माह - <?php if ($_POST['datef'] == ''){	echo '';} else{echo date('m/Y', strtotime($_POST['datef']));
...
<table border="1" cellspacing="0" cellpadding="5" style="text-align:center" id="print" width="960px" class="table table-striped table-bordered table-hover">
  ...
  <tr>
	...
	elseif ($i===6){ $j = 15 ; $k =39;  echo "छेडछाड-धारा 354 क,ख,ग,घ भादवि";}
	...
	elseif ($i===10){ $j = 61 ; echo "आत्महत्या के लिये दुष्प्रेरित करना-धारा 306 भादवि";}
  ...
  <tr>
    ...
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt12->bind_param("iiisss", $j, $k, $branch_id, $gender, $datef, $date1) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
	}
	else
	{

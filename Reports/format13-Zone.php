...
<span style="float:right;margin-right:-25px"> <input type="hidden" id="datatodisplay" name="datatodisplay" style="" /> <input type="submit" value="Export to Excel" class="btn btn-warning"/>
 ...
 <div class="row">
    <div class="col-lg-12 label-primary" style="color:#FFF">
      <form action="format13-Zone.php" method="post" name="Search" enctype="multipart/form-data" id="popup-validation" role="form">
...
<?php
	  ...
	  $dsr_caste= 'SC';
	if ( !$stmt2 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND 	sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt2->bind_param("ssss",$datef, $date1,$dsr_caste,$ipc[$x]) )
	...
	<span><?php echo $cid2;?></span>
	  ...
	  $police_dsr->select_db("ftcaaazc_dsr");
	  $dsr_caste= 'ST';
	if ( !$stmt3 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND 	sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt3->bind_param("ssss",$datef, $date1,$dsr_caste,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt3->execute() ) 
...
<?php
	...
	if ( !$stmt4 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt4->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt4->execute() ) 
	...
	<span><?php echo $cid4;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='विवेचना में लंबित';
	if ( !$stmt5 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt5->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt5->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='बंदी आरोपी';
	if ( !$stmt6 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt6->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt6->execute() ) 
	...
	<span><?php echo $cid6;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='बंदी आरोपी';
	if ( !$stmt7 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt7->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt7->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='खात्मा';
	if ( !$stmt8 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt8->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt8->execute() ) 
	...
	<span><?php echo $cid8;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='खात्मा';
	if ( !$stmt9 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt9->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt9->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='खारची';
	if ( !$stmt10 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND	sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt10->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt10->execute() ) 
	...
	<span><?php echo $cid10;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='खारची';
	if ( !$stmt11 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt11->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt11->execute() ) 
...
<?php
	...
	if ( !$stmt12 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt12->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt12->execute() ) 
	...
	<span><?php echo $cid12;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='न्यायालय में प्रस्तुत';
	if ( !$stmt13 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt13->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt13->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_decision='सजा';
	if ( !$stmt14 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt14->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt14->execute() ) 
	...
	<span><?php echo $cid14;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_decision='सजा';
	if ( !$stmt15 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt15->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt15->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_decision='दोषमुक्त';
	if ( !$stmt16 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt16->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt16->execute() ) 
	...
	<span><?php echo $cid16;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_decision='दोषमुक्त';
	if ( !$stmt17 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt17->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt17->execute() ) 
...
<?php
	...
	if ( !$stmt18 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt18->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt18->execute() ) 
	...
	<span><?php echo $cid18;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='न्यायालय में लंबित';
	if ( !$stmt19 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt19->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt19->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='विवेचनाधीन';
	if ( !$stmt20 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt20->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt20->execute() ) 
	...
	<span><?php echo $cid20;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='विवेचनाधीन';
	if ( !$stmt21 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt21->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$ipc[$x]) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt21->execute() ) 
...
<?php
	...
	if ( !$stmt22 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt22->bind_param("ssss",$datef, $date1,$dsr_caste,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt22->execute() ) 
	...
	<span><?php echo $cid22;?></span>
	  ...
	  $dsr_caste= 'ST';
	  $sc_st_act='धारा 3(1)10';
	if ( !$stmt23 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt23->bind_param("ssss",$datef, $date1,$dsr_caste,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt23->execute() ) 
...
<?php
	  ...
	  $c_status='विवेचना में लंबित';
	  $sc_st_act='धारा 3(1)10';
	if ( !$stmt24 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt24->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt24->execute() ) 
	...
	<span><?php echo $cid24;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='विवेचना में लंबित';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt25 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt25->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt25->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='बंदी आरोपी';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt26 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if (!$stmt26->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt26->execute() ) 
	...
	<span><?php echo $cid26;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='बंदी आरोपी';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt27 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt27->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt27->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='खात्मा';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt28 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt28->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt28->execute() ) 
	...
	<span><?php echo $cid28;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='खात्मा';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt29 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt29->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt29->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='खारची';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt30 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND	sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt30->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt30->execute() ) 
	...
	<span><?php echo $cid30;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='खारची';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt31 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt31->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt31->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='न्यायालय में प्रस्तुत';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt32 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt32->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt32->execute() ) 
	...
	<span><?php echo $cid32;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='न्यायालय में प्रस्तुत';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt33 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=? ") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt33->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt33->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_decision='सजा';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt34 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt34->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt34->execute() ) 
	...
	<span><?php echo $cid34;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_decision='सजा';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt35 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt35->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt35->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_decision='दोषमुक्त';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt36 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt36->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt36->execute() ) 
	...
	<span><?php echo $cid36;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_decision='दोषमुक्त';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt37 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_decision=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt37->bind_param("sssss",$datef, $date1,$dsr_caste,$c_decision,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt37->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='न्यायालय में लंबित';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt38 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt38->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt38->execute() ) 
	...
	<span><?php echo $cid38;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='न्यायालय में लंबित';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt39 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt39->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt39->execute() ) 
...
<?php
	  ...
	  $dsr_caste= 'SC';
	   $c_status='विवेचनाधीन';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt40 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt40->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt40->execute() ) 
	...
	<span><?php echo $cid40;?></span>
	  ...
	  $dsr_caste= 'ST';
	   $c_status='विवेचनाधीन';
	   $sc_st_act='धारा 3(1)10';
	if ( !$stmt41 = $police_dsr->prepare("SELECT COUNT(id) FROM dsr_entries WHERE (dsr_kaymi_date >= ? and dsr_kaymi_date <= ?) AND dsr_caste=? AND c_status=? AND sc_st_act!=?") ) 
    echo "Prepare Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt41->bind_param("sssss",$datef, $date1,$dsr_caste,$c_status,$sc_st_act) )
    echo "Binding Parameter Error: ($police_dsr->errno) $police_dsr->error";
    if ( !$stmt41->execute() ) 

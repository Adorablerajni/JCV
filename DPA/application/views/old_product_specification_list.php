                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										...
										<td><?php echo $product_value['shipper'];?></td>
										<td><?php echo $product_value['hsn_code'];?></td>
										<td><img src="<?php echo base_url(); ?>/<?php echo $product_value['product_image'];?>" width="50px" height="50px" /></td>
										<td><a href="<?php echo base_url(); ?>Masters/edit_product_specification/<?php echo $product_value['id'];?>" target="_new">Edit</a></td>
										<td><a href="<?php echo site_url(); ?>Masters/delete_product/<?php echo $product_value['id'];?>" onclick="return confirm('Are you sure want to delete');">Delete</a></td>
										</tr>
                                        <?php }} ?>										

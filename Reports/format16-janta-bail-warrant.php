...
<div class="notice_all">
  ...
  <?php
   ...
   {
  ?>
<p align="left" style="float:left;margin-left:-30px;">Format16-janta-bail-warrant</p>
<p align="right"></p>
  <div class="mar10">
  <?php   
...
$z++;	   ?>             
	...
	$sub_id='No';
	$a=0;
	if ( !$stmt3 = $police_summons->prepare("SELECT id, sakshi_name FROM summon_list WHERE sp_id = ? AND warrant_type = ? AND (samans_date between ? AND ?)  AND sub_id=? AND aaropi_type=?") )
    echo "Prepare Error: ($police_summons->errno) $police_summons->error";

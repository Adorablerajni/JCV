        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="text-transform:capitalize"><?php echo $_SESSION['name']; ?></div>
                    <div class="email"><?php echo $_SESSION['name']; ?></div>
                ...
                <ul class="list">
                    ...
                    <?php  if($_SESSION['user_role'] == 'admin'){?>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?php echo base_url(); ?>questions_responses">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>poll_response">
                                    <i class="material-icons">reply</i>
                                    <span>Poll Responses</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>url_list">

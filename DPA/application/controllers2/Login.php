        ...
        if($username!='')
       {
            ...
            if($return['flag']==1){
                ...
                $data = array(
                                ...
                                'MM_UserGroup'=>$return['resultData']['designation'],
                                'City'=>$return['resultData']['city'],
								'Branch_Name'=>$return['resultData']['branch_name'],
                                'Department_Id'=>$return['resultData']['dept_name'],
								'Department'=>$return['resultData']['department'],
                                'SP'=>$return['resultData']['SP'],
                                'MM_UserType'=>$return['resultData']['user_type'],
                                'MM_off_deg'=>$return['resultData']['off_desg'],

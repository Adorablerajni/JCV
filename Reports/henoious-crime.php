...
<span style="float:right;margin-right:-25px"> <input type="hidden" id="datatodisplay" name="datatodisplay" style="" /> <input type="submit" value="Export to Excel" class="btn btn-warning"/>
 ...
 <div class="row">
   ...
   <div class="col-lg-12 navStuff" style="padding:15px 5px;margin:0px auto;width:960px;">    
        <div class="col-lg-12 navStuff">  &nbsp; <!--<label>दिनांक:</label>
...
<p align="right"></p>
  ...
  ?>
    ...
    <p align="center"><span> चिन्हित अपराध <br /> वर्ष : 2008 - 2019<br /><?php if ($_POST['sp_office'] != 0){ ?> जिला - <?php echo $branch_name1; echo ", "; echo $city1; } else { echo "इन्दौर जोन"; }?> </span></p>
 <br />
 <?php	  
  //$datef = $_POST['datef'];
  //$date1 = $_POST['datel'];
 ...
 ?>
  ...
  <tr>
	...
	<td>
	<?php 
	$sum = $result[0]+$result[1]+$result[2]+$result[3]+$result[4]+$result[5]+$result[6]+$result[7]+$result[8]+$result[9]+$result[10]+$result[11]; 
	$ipc[$i]=$sum;
        echo $sum;
	?>
	</td>
	...
	<tr>
            ...
            $percent_friendly13 = number_format( $percent13 * 100, 2 ) . ' %' ;
            echo $percent_friendly13 ;
            ?>
            </td>

            ...
            <div class="feature-cat-product-wrap">
              ...
              <div class="feature-cat-image">
                <a href="<?php echo esc_url( $terms_link ); ?>">
                  <?php 
                  $thumbnail_id = get_term_meta($cat_product_category, 'thumbnail_id', true);
                  if (!empty($thumbnail_id)) {
                    ...
                    ?>
                    <img src="<?php echo esc_url(get_template_directory_uri().'/assets/images/img388x388.png');?>" alt="<?php esc_attr_e('No Image','ghumti')?>"/>
                    <?php 
                  } ?>
                </a>

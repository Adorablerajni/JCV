        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo base_url(); ?>"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>Purchase_List/add_purchase">
                            <i class="material-icons">add</i>
                            <span>New Purchase</span>
                        </a>
                    </li>
					<li>
                        <a href="<?php echo base_url(); ?>Purchase_List/purchase_list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>Product_list/product_list">
                                    <span>Products</span>
                                </a>
                            </li>
							<li>

...
?>										
									<tr>
									  ...
									  <td><?php echo $party_val['whatsapp_no'];?></td>
									  ...
									  <td><?php echo $party_val['dl_no'];?></td>
									  <td><a href="<?php echo site_url(); ?>Masters/edit_party/<?php echo $party_val['party_id'];?>">Edit</a></td>
									  <td><a href="<?php echo site_url(); ?>Masters/delete_party/<?php echo $party_val['party_id'];?>" onclick="return confirm('Are you sure want to delete');">Delete</a></td>
									</tr>  
<?php }} ?>									

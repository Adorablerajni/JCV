...
<span style="float:right;margin-right:-25px"> <input type="hidden" id="datatodisplay" name="datatodisplay" style="" /> <input type="submit" value="Export to Excel" class="btn btn-warning"/>
 ...
 <div class="row">
    <div class="col-lg-12 label-primary" style="color:#FFF">
      <form action="format8-CRPC.php" method="post" name="Search" enctype="multipart/form-data" id="popup-validation" role="form">
...
<br />
	  ...
	  for($i=0;$i<$arrlength;$i++)
  {
    ...
    $st1->bind_param("ss", $sp, $_SESSION['MM_Zone']);
    $st1->execute();
    $st1->store_result();
	...
	$ic[$i][$l]=$cid17;
	?>
	<span><?php if($cid17 >0){ echo $cid17;} else{ echo '0';}?><?php // echo $cid17; ?></span>
		</td>
